...
def get_resource_path(relative_path):
    """
    Resolve caminhos de recursos tanto em desenvolvimento quanto compilado.
    
    Em desenvolvimento: busca a partir do diretório raiz do projeto
    Quando compilado: busca dentro do diretório temporário do PyInstaller
    """
    if hasattr(sys, '_MEIPASS'):
        # Estamos rodando em uma versão compilada
